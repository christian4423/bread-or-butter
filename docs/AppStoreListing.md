...
FEATURES
• A playful butter-and-baguette ratio bar with smooth animation
• Heart-rate zones from your resting heart rate and age — read automatically
  from Health, or set your own in Settings
• Medication offset: if a stimulant raises your heart rate, subtract a few BPM
  so your zones reflect true effort
